...
/* 	$("#mod").click( function () {
	...
	function commentDelete(commentNo) {
		$.ajax({
			url: "<c:url value='/articleBoard/commentDelete'/>",
			data: {
				no: "${board.no}", 
				commentNo: commentNo
			},
	...
	function commentUpdate(commentNo) {
		$.ajax({
			url: "<c:url value='/articleBoard/commentUpdate'/>",
			type: "POST",
			data: {
				no: "${board.no}", 
	...
	$("#rForm").submit(function (e) {
		...
		$.ajax({
			url: "<c:url value='/articleBoard/commentRegist'/>",
			type: "POST",
			data: {
				no: "${board.no}", 
	...
	function commentList() {
		$.ajax({
			url: "<c:url value='/articleBoard/commentList'/>",
			data: {no: "${board.no}"},
			dataType: "json", 
			success: makeCommentList
		});
